...
In order to support loading of multiple wallets in divx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is divx.cpp.
...
Changes to divx.cpp
----------------------
divx.cpp is the entry point into divx-qt, and as such, will require some minor modifications to provide hooks for
