#!/usr/bin/env python3
# Copyright (c) 2015-2019 The Divi Core developers
...
class FullBlockTest(DiviTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure divid isn't accepting b26
        ...
        # Extend the b28 chain to make sure divid isn't accepting b28
        ...
        # divid doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the divi code has custom code which does so);
