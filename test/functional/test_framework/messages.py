...
"""Divi test framework primitive and message structures
...
COIN = 100000000  # 1 divi in satoshis
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in divid
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in divid indicates these should be deserialized as blocks
