...
// divi includes.
#include <..\src\script\diviconsensus.h>
...
int main()
{
    std::cout << "diviconsensus version: " << diviconsensus_version() << std::endl;
    ...
    auto op0Result = diviconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, diviconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
