...
This mechanism has been integrated into Bitcore-Node-DIVI which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Divi-Project/insight-api-divi#web-socket-api](https://github.com/Divi-Project/insight-api-divi#web-socket-api) 
* API: [https://github.com/Divi-Project/insight-api-divi#swifttx-transactions](https://github.com/Divi-Project/insight-api-divi#swifttx-transactions) 
