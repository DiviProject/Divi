...
extern json_spirit::Value getexpandedstatistics(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value totalinputsforblock(const json_spirit::Array& params, bool fHelp);
