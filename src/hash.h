...
/** A hasher class for Divi's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Divi's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
...

{
    ...
    uint512 mask = uint512(8);
    uint512 zero = uint512(0);
