...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward, bool freeDivi = false)
{
 ...
 *   vMerkleTree: 4a5e1e
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward, bool freeDivi = false)
{
    const char* pszTimestamp = "September 26, 2018 - US-Iran: Trump set to chair key UN Security Council session";
    const CScript genesisOutputScript = CScript() << ParseHex("04bcc3ef3417ba00ab55e3de807a776ade43cbd634a7e2cff383fecc6920cf918b2ad427f6b0a3f8d38f5a41d5dcbf35b394521bd08fcb5f40749df5bfe7d42fe2") << (freeDivi ? OP_TRUE : OP_CHECKSIG);
...
public:
    CMainParams() {
        ...
        consensus.nLotteryBlockStartBlock = 101;
        ...
        // We deploy all next bips(CSV and Segwit) using a hardfork at nSegwitHeight
        // Deployment of BIP68, BIP112, and BIP113. // TODO
        // consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        // consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1580072400; // May 1st, 2016
        // consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 0; // May 1st, 2017

        // Deployment of SegWit (BIP141, BIP143, and BIP147) // TODO
        // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1580072400; // November 15th, 2016.
        // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 0; // November 15th, 2017.

        // The best chain should have at least this much work. // TODO
//        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000028822fef1c230963535a90d");
        consensus.nMinimumChainWork = uint256S("0x0");

        // By default assume that the signatures in ancestors of this block are valid. // TODO
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        fRequireSamePeerVersion = true;
        consensus.nSubsidyHalvingInterval = 60 * 24 * 365;
        consensus.BIP16Exception = uint256S("0x00000000dd30457c001f4095d208cc1296b0eed002427aa599874af7a432b105");
        consensus.BIP34Height = 200;
        consensus.BIP34Hash = uint256S("0x0000000023b3a96d3484e5abb3755c413e7d41500f8e2a5c3f0dd01299cd8ef8");
        consensus.BIP65Height = 200; // 00000000007f6655f22f98e72ed80d8b06dc761d5da09df0fa1dc4be4f861eb6
        consensus.BIP66Height = 200; // 000000002104c8c45e99a8853285a3b592602a3ccde2b832481da85e9e4ba182
        consensus.nSegwitHeight = 200;
        consensus.powLimit = ArithToUint256(~arith_uint256(0) >> 20);
        consensus.nPowTargetTimespan = 1 * 60 * 60; // one hour
        consensus.nPowTargetSpacing = 1 * 60;
        consensus.nPoSTargetSpacing = 1 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        consensus.nTreasuryPaymentsStartBlock = 101;
        consensus.nTreasuryPaymentsCycle = 60 * 24 * 7 + 1;
        consensus.nSegwitHardForkPayment = 200;
        ...
        genesis = CreateGenesisBlock(1557171200, 92676, 0x1e0ffff0, 1, 50 * COIN, true);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000008e145adf0330e6de3a844b76f5163e0b2011a5ef270c7c7b3d4410c7b31"));
        assert(genesis.hashMerkleRoot == uint256S("0xec803cc6b5e68728ec0117cb1154b6d2893152f89d61319647db106908888bd6"));

        vFixedSeeds.clear();
        vSeeds.clear();
//         nodes with support for servicebits filtering should be at the top
//        vSeeds.emplace_back("testnet-seed.divi.jonasschnelli.ch");
//        vSeeds.emplace_back("seed.tbtc.petertodd.org");
//        vSeeds.emplace_back("seed.testnet.divi.sprovoost.nl");
...
//        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x207fffff, 1, 50 * COIN, true);
        consensus.hashGenesisBlock = genesis.GetHash();
