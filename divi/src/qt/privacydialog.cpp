...
//     // "Spending 999999 zDIV ought to be enough for anybody." - Bill Gates, 2017
//     // ui->zDIVpayAmount->setValidator( new QDoubleValidator(0.0, 21000000.0, 20, this) );
...
//     ui->labelzDIVSyncStatus->setText("(" + tr("out of sync") + ")");
...
//         ui->pushButtonMintzDIV->setEnabled(false);
//         ui->pushButtonMintzDIV->setToolTip(tr("zDIV is currently disabled due to maintenance."));

//         ui->pushButtonSpendzDIV->setEnabled(false);
//         ui->pushButtonSpendzDIV->setToolTip(tr("zDIV is currently disabled due to maintenance."));
//     }
// }
...
//         ui->zDIVpayAmount->setFocus();
//     }
// }

// void PrivacyDialog::on_pushButtonMintzDIV_clicked()
// {
//     if (!walletModel || !walletModel->getOptionsModel())
//         return;
...
//                                  tr("zDIV is currently undergoing maintenance."), QMessageBox::Ok,
//                                  QMessageBox::Ok);
//         return;
//     }
...
//     ui->TEMintStatus->setPlainText(tr("Minting ") + ui->labelMintAmountValue->text() + " zDIV...");
...
//     QString strStatsHeader = tr("Successfully minted ") + ui->labelMintAmountValue->text() + tr(" zDIV in ") + 
...
// void PrivacyDialog::on_pushButtonSpendzDIV_clicked()
// {
...
//     if(GetAdjustedTime() > GetSporkValue(SPORK_16_ZEROCOIN_MAINTENANCE_MODE)) {
//         QMessageBox::information(this, tr("Mint Zerocoin"),
//                                  tr("zDIV is currently undergoing maintenance."), QMessageBox::Ok, QMessageBox::Ok);
//         return;
//     }
...
//             return;
//         }
//         // Wallet is unlocked now, sedn zDIV
//         sendzDIV();
//         return;
//     }
//     // Wallet already unlocked or not encrypted at all, send zDIV
//     sendzDIV();
// }
...
//     else{
//         if (!address.IsValid()) {
//             QMessageBox::warning(this, tr("Spend Zerocoin"), tr("Invalid Divi Address"), QMessageBox::Ok, QMessageBox::Ok);
//             ui->payTo->setFocus();
//             return;
//         }
//     }
...
//     double dAmount = ui->zDIVpayAmount->text().toDouble();
...
//     // Warn for additional fees if amount is not an integer and change as zDIV is requested
...
//         strFeeWarning += QString::number(dzFee, 'f', 8) + " DIV </b>will be added to the standard transaction fees!<br />";
...
//     QString strAmount = "<b>" + QString::number(dAmount, 'f', 8) + " zDIV</b>";
...
//         strStats += tr("zDiv Spend #: ") + QString::number(nCount) + ", ";
...
//         strStats += tr("value out: ") + FormatMoney(txout.nValue).c_str() + " Div, ";
//         nValueOut += txout.nValue;

//         strStats += tr("address: ");
//         CTxDestination dest;
//         if(txout.scriptPubKey.IsZerocoinMint())
//             strStats += tr("zDiv Mint");
...
//                         QString::number(nSumPerCoin) + " zDIV </b>";
...
//     ui->labelzAvailableAmount->setText(QString::number(zerocoinBalance/COIN) + QString(" zDIV "));
//     ui->labelzAvailableAmount_2->setText(QString::number(matureZerocoinBalance/COIN) + QString(" zDIV "));
//     ui->labelzDIVAmountValue->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, balance - immatureBalance - nLockedBalance, false, BitcoinUnits::separatorAlways));
// }
...
// {
//     ui->labelzDIVSyncStatus->setVisible(fShow);
// }
