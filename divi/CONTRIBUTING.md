Contributing to DIVX Core
============================

The DIVX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DIVX Core project, and is not to be
confused with overall DIVX Network Protocol consensus changes.

Whether a pull request is merged into DIVX Core rests with the project merge
...
Patches that change DIVX consensus rules are considerably more involved than
...
Where a patch set proposes to change the DIVX consensus, it must have been
...
The project leader is the release manager for each DIVX Core release.
