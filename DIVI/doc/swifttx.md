...
This mechanism has been integrated into Bitcore-Node-DIVX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Divi-Project/insight-api-divx#web-socket-api](https://github.com/Divi-Project/insight-api-divx#web-socket-api) 
* API: [https://github.com/Divi-Project/insight-api-divx#swifttx-transactions](https://github.com/Divi-Project/insight-api-divx#swifttx-transactions) 
...
By default, the DIVX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DIVX Core daemon:
