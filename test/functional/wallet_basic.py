...
class WalletTest(DiviTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DIVI from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 divi in block rewards plus fees, but
        ...
        # Send 10 DIVI with subtract fee from amount
        ...
        # Sendmany 10 DIVI with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/divi/divi/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
