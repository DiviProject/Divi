#!/usr/bin/env python3
# Copyright (c) 2016-2018 The Divi Core developers
...
# TestP2PConn: A peer we use to send messages to divid, and store responses.
...
class CompactBlocksTest(DiviTestFramework):
    ...
    # This test actually causes divid to (reasonably!) disconnect us, so do this last.
    ...
    # Test that divid requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for divid to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # divid will not send blocktxn responses for blocks whose height is
