...
In order to support loading of multiple wallets in divi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is divi.cpp.
...
Changes to divi.cpp
----------------------
divi.cpp is the entry point into divi-qt, and as such, will require some minor modifications to provide hooks for
