...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The New York Times 02/May/2018 Amazon, Not waiting for HQ2, Announces Projects in Boston and Vancouver";
        CTransaction txNew;
        txNew.nTime = 1526389517;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
