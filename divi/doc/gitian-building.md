...
git clone https://github.com/divi-crypto/divi.git
cd divi
...
Follow the instructions in [doc/release-process.md](release-process.md) in the divi repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the divi repository.
...
```bash
    ...
    From https://github.com/divi-crypto/divi
...
./bin/gbuild --commit divi=${COMMIT} --url divi=${URL} ../divi/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit divi=${COMMIT} --url divi=${URL} ../divi/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit divi=${COMMIT} --url divi=${URL} ../divi/contrib/gitian-descriptors/gitian-osx.yml
```
...
[divi/gitian.sigs](https://github.com/divi-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
