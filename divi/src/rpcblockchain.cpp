...
Value getexpandedstatistics(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
          ...
          "         \"total_transactions\":n,     (numeric) The total number of transactions in the blockchain\n"
          "         \"average_block_size_24h_in_bytes\": n,  (numeric) The average block size in bytes over the last 24h\n"
          "         \"transaction_count_24h\": n,            (numeric) The average number of transactions in the last 24h\n"
          "     }\n"
          "     \"utxo_statistics\": {\n"
          "         \"total_utxos\":n,         (numeric) Total number of UTXOs\n"
          "         \"useless_utxos\": n,      (numeric) Number of UTXOs that cannot be spent\n"
          "         \"relevant_utxos\": n,     (numeric) Number of UTXOs that could be spent\n"
          "     }\n"
          "     \"burned_fees\": (numeric) Total value of fees burned in non-treasury, non-lottery blocks\n"
            "}\n");
