    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            while (true)
            {
                ...
                nFeeNeeded = GetMinimumFee(nValue, nBytes, *this);
                ...
                if (nFeeRet >= nFeeNeeded) {
                    ...
                    if (nChangePosInOut == -1 && nSubtractFeeFromAmount == 0 && pick_new_inputs) {
                        ...
                        CAmount fee_needed_with_change = GetMinimumFee(nValue, tx_size_with_change, *this);
...
bool CWallet::CreateCoinStake(unsigned int nBits,
                              const CBlockRewards &blockReward,
                              CMutableTransaction &txNew,
                              ...
                              bool fGenerateSegwit)
{
    ...
    LogPrintf("CreateCoinStake -- nBlockHeight %d blockReward %lld txNew %s",
              nHeight, blockReward.ToString(), CTransaction(txNew).ToString());
 ...
 * https://divitalk.org/?topic=54527, or
 * https://github.com/divi/divi/pull/1393.
 */
