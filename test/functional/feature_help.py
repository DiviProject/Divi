...
"""Verify that starting divi with -h works as expected."""

from test_framework.test_framework import DiviTestFramework
from test_framework.util import assert_equal

class HelpTest(DiviTestFramework):
    ...
    def run_test(self):
        self.log.info("Start divi with -h for help text")
        ...
        self.log.info("Start divi with -version for version information")
        ...
        self.log.info("Start divid with -fakearg to make sure it does not start")
