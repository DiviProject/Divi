                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DIVX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DIVX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and divx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DIVX Core"), this);
    aboutAction->setStatusTip(tr("Show information about DIVX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DIVX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DIVX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DIVX addresses"));
    ...
    openAction->setStatusTip(tr("Open a DIVX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DIVX Core help message to get a list with possible DIVX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DIVX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DIVX network", "", count));
}
...
{
    QString strTitle = tr("DIVX Core"); // default title
