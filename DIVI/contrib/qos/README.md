...
This means one can have an always-on divxd instance running, and another local divxd/divx-qt instance which connects to this node and receives blocks from it.
