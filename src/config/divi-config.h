/* src/config/divi-config.h.  Generated from divi-config.h.in by configure.  */
/* src/config/divi-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Divi Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Divi Core"
...
#define PACKAGE_BUGREPORT "https://github.com/divi/divi/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Divi Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Divi Core 1.0.8"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "divi"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://divicore.org/"
