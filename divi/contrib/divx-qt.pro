...
RESOURCES += src/qt/divx.qrc src/qt/divx_locale.qrc

TRANSLATIONS += src/qt/locale/divx_bg.ts \
                src/qt/locale/divx_de.ts \
                src/qt/locale/divx_en.ts \
                src/qt/locale/divx_es.ts \
                src/qt/locale/divx_fi.ts \
                src/qt/locale/divx_fr.ts \
                src/qt/locale/divx_it.ts \
                src/qt/locale/divx_ja.ts \
                src/qt/locale/divx_pl.ts \
                src/qt/locale/divx_pt.ts \
                src/qt/locale/divx_ru.ts \
                src/qt/locale/divx_sk.ts \
                src/qt/locale/divx_sv.ts \
                src/qt/locale/divx_vi.ts \
                src/qt/locale/divx_zh_CN.ts \
                src/qt/locale/divx_zh_TW.ts
